	...
	x.defaults = {
		...
		dom: {
			...
			collection: {
				tag: "div",
				className:
					"absolute z-10 mt-2 origin-top rounded-md bg-[#fafafa] shadow-lg ring-opacity-5 w-[8vw]",
			},
			button: {
				tag: "button",
				className:
					"inline-flex w-full justify-center gap-x-1.5 rounded-md bg-[#fafafa] px-3 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-50",
			...
			splitDropdownButton: {
				tag: "button",
				className:
					"inline-flex w-full justify-center gap-x-1.5 rounded-md bg-[#fafafa] px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50",
			},
			splitCollection: {
				tag: "div",
