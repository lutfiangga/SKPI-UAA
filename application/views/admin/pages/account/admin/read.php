					...
					?>
						...
						<dialog id="addAkun" class="modal overflow-hidden">
							<div class="modal-box bg-[#fafafa] w-full sm:w-11/12 lg:max-w-5xl mx-auto p-4">
								...
								<?php endif; ?>
								<form method="post" action="<?= site_url('Admin/Account/Admin/save'); ?>" enctype="multipart/form-data" role="form">
									<?= csrf(); ?>
									<div class="mb-4">
						...
						<dialog id="editAkun" class="modal overflow-hidden">
							<div class="modal-box bg-[#fafafa] w-11/12 max-w-5xl">
								...
								<?php endif; ?>
								<form method="post" action="<?= site_url('Admin/Account/Admin/update/' . $row['id_akun']); ?>" enctype="multipart/form-data" role="form">
									<?= csrf(); ?>
