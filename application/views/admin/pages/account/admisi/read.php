<section class="relative flex flex-col justify-between">
					...
					?>
						<tr class="border-t">
							...
							<td class="px-4 py-2 flex flex-row items-center justify-center mt-2 gap-2">
								...
								<a href="<?= site_url('Admin/Account/Admisi/edit/' . $row['id_akun']); ?>" class="rounded-full p-2 bg-orange-100 text-orange-600 hover:scale-125 hover:bg-orange-200 flex items-center gap-2">
	...
	<dialog id="hapusAkun" class="modal overflow-hidden">
		<div class="modal-box bg-[#fafafa]">
			...
			<form method="post" action="<?= site_url(ucwords($role) . '/Account/Admisi/delete/'); ?>">
				<?= csrf(); ?>
	...
	<dialog id="resetPassword" class="modal overflow-hidden">
		<div class="modal-box bg-[#fafafa]">
			...
			<form method="post" action="<?= site_url(ucwords($role) . '/Account/Admisi/resetPassword/'); ?>">
				<?= csrf(); ?>
