<section class="relative flex flex-col justify-between">
	...
	<section class="relative bg-[#fafafa] rounded-2xl lg:p-8 p-4 my-4">
		<form method="post" action="<?= site_url(ucwords($role) . '/Jenjang/save') ?>"
			enctype="multipart/form-data" role="form">
			<?= csrf(); ?>
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				<div class="">
					<label for="tingkat_jenjang" class="block text-sm font-medium text-gray-700 mb-2">Tingkat Jenjang:</label>
					<input type="text" id="tingkat_jenjang" name="tingkat_jenjang" required
				...
				<div class="">
					...
					<select id="jenjang_kualifikasi" required name="jenjang_kualifikasi" class="block bg-off-white w-full mt-1 p-2 border border-gray-300 rounded-md" data-search="true">
						...
						<option value="4">Jenjang 4</option>
						<option value="5">Jenjang 5</option>
						<option value="6">Jenjang 6</option>
						<option value="7">Jenjang 7</option>
						<option value="8">Jenjang 8</option>
						<option value="9">Jenjang 9</option>
					</select>
				</div>
				<div class="col-span-2">
					...
					<textarea type="text" id="syarat_penerimaan" name="syarat_penerimaan" required rows="2"
						...
						placeholder="contoh: Lulus SMA/SMK/Sederajat"></textarea>
				</div>
			</div>
