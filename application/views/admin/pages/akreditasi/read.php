<section class="relative flex flex-col justify-between">
	...
	<section class="relative bg-[#fafafa] rounded-2xl lg:p-8 p-4 my-4">
		<!-- add user -->
		<a href="<?= site_url('Admin/Akreditasi/create'); ?>" id="openAddAkredModal" class="btn max-w-[15rem] bg-blue-600 border-none text-[#fafafa] hover:bg-[#fafafa]/30 hover:text-blue-600 hover:border-2 hover:border-blue-600 hover:shadow-md mb-4 md:w-auto flex flex-row items-center">
			...
			<table id="" class="min-w-full table-auto table-data">
				...
				<tbody>
					...
					foreach ($read as $row) { ?>
						...
						<!-- Modal Hapus Akreditasi -->
						<dialog id="hapusAkreditasi" class="modal overflow-hidden">
...
<script>
	const openDeleteModal = (id) => {
		...
		document.getElementById('hapusAkreditasi').showModal();
	}
</script>
