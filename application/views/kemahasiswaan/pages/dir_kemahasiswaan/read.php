		...
		<dialog id="addDirektur" class="modal overflow-hidden">
			<div class="modal-box bg-[#fafafa]">
				...
				<h3 class="text-xs sm:text-sm md:text-base font-bold text-blue-600 flex flex-row items-center">
					Tambah Direktur Kemahasiswaan
					<div class="bg-blue-600 md:p-3 p-2 text-[#fafafa] rounded-lg ml-2 md:ml-4">
						<i data-feather="image" class="w-4 h-4"></i>
					</div>
				</h3>
				<div class="divider border-gray-400"></div>
				<form method="post" action="<?= site_url('Kemahasiswaan/Dir_Kemahasiswaan/add_direktur/') ?>" enctype="multipart/form-data" role="form">
					<?= csrf(); ?>
					<div class="mb-4">
						...
						<select id="direktur" name="id_direktur" class="block bg-off-white w-full mt-1 p-2 border border-gray-300 rounded-md" data-search="true">
							...
							<?php foreach ($staff->result_array() as $r) { ?>
	...
	<?php if (!empty($direktur)): ?>
		...
		<dialog id="changeDirektur" class="modal overflow-hidden">
			<div class="modal-box bg-[#fafafa]">
				...
				<h3 class="text-xs sm:text-sm md:text-base font-bold text-blue-600 flex flex-row items-center">
					Ganti Direktur Kemahasiswaan
					<div class="bg-blue-600 md:p-3 p-2 text-[#fafafa] rounded-lg ml-2 md:ml-4">
						<i data-feather="image" class="w-4 h-4"></i>
					</div>
				</h3>
				<div class="divider border-gray-400"></div>
				<form method="post" action="<?= site_url('Kemahasiswaan/Dir_Kemahasiswaan/update/' . $direktur['id']); ?>" enctype="multipart/form-data" role="form">
					<?= csrf(); ?>
					<div class="mb-4">
						<label for="direktur" class="block text-sm font-medium text-gray-700 mb-2">Direktur Mahasiswa:</label>
						<select id="direktur" name="id_direktur" class="block bg-off-white w-full mt-1 p-2 border border-gray-300 rounded-md" data-search="true">
	...
	<?php if (!empty($direktur)): ?>
		...
		<dialog id="editSignature" class="modal overflow-hidden">
			<div class="modal-box bg-[#fafafa]">
				...
				<div class="divider border-gray-400"></div>
				<form method="post" action="<?= site_url('Kemahasiswaan/Dir_Kemahasiswaan/change_signature/') . $direktur['id']; ?>" enctype="multipart/form-data" role="form">
					<?= csrf(); ?>
					<div class="mb-4">
	...
	<?php if (!empty($direktur)): ?>
		...
		<dialog id="editStamp" class="modal overflow-hidden">
			<div class="modal-box bg-[#fafafa]">
				...
				<div class="divider border-gray-400"></div>
				<form method="post" action="<?= site_url('Kemahasiswaan/Dir_Kemahasiswaan/change_stamp/') . $direktur['id']; ?>" enctype="multipart/form-data" role="form">
					<?= csrf(); ?>
					<div class="mb-4">
