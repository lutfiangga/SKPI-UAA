<section class="relative flex flex-col justify-between">
	...
	<section class="relative bg-[#fafafa] rounded-2xl lg:p-8 p-4 my-4">
		<form method="post" action="<?= site_url(ucwords($role) . '/Periode_Spm/save') ?>"
			enctype="multipart/form-data" role="form">
			<?= csrf(); ?>
			<div>
				<div class="mb-4">
					<label for="periode" class="block text-sm font-medium text-gray-700 mb-2">Tahun Periode:</label>
					<input type="number" inputmode="numeric" id="periode" name="periode" required
						...
						placeholder="Masukkan tahun periode contoh: 2020" />
				</div>

				<div class="mb-4">
					<label for="periode_kegiatan" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Maksimal Kegiatan:</label>
					<input type="date" id="periode_kegiatan" name="periode_kegiatan"
			...
			<div class="inline-flex gap-2 md:gap-4">
				<a href="<?= site_url(ucwords($role) . '/Periode_Spm'); ?>" class="btn bg-red-600 border-none text-[#fafafa] hover:bg-orange-400 hover:text-[#fafafa] hover:border-2 hover:border-blue-600 hover:shadow-md mb-4">Close</a>
