<section class="relative flex flex-col justify-between">
	...
	<section class="relative bg-[#fafafa] rounded-2xl lg:p-8 p-4 my-4">
		<form method="post" action="<?= site_url(ucwords($role) . '/Spm_Mahasiswa/save/') ?>" enctype="multipart/form-data" role="form">
			<?= csrf(); ?>
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div class="flex flex-col">
					...
					<input type="text" required id="nama_kegiatan" name="nama_kegiatan" class="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan Nama Kegiatan">
				</div>

				<!-- Penyelenggara -->
				<div class="flex flex-col">
					<label for="penyelenggara" class="mb-2 text-sm font-medium text-gray-700">Penyelenggara:</label>
					<input type="text" required id="penyelenggara" name="penyelenggara" class="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan Penyelenggara">
				</div>

				<!-- Tanggal -->
				<div class="flex flex-col relative">
					<label for="tanggal_mulai" class="mb-2 text-sm font-medium text-gray-700">Tanggal Mulai:</label>
					<input id="tanggal_mulai" type="text" required name="tanggal_mulai" class="pickdate p-2 w-full rounded-md bg-[#fafafa] focus:ring-inset focus:ring-blue-400 border border-gray-300" placeholder="Tanggal mulai">
				</div>

				<div class="flex flex-col relative">
					<label for="tanggal_selesai" class="mb-2 text-sm font-medium text-gray-700">Tanggal Selesai:</label>
					<input type="text" id="tanggal_selesai" name="tanggal_selesai" class="pickdate p-2 w-full rounded-md bg-[#fafafa] focus:ring-inset focus:ring-blue-400 border border-gray-300" placeholder="tanggal Selesai">
				</div>

				<!-- Link Kegiatan -->
				<div class="flex flex-col">
					<label for="url" class="mb-2 text-sm font-medium text-gray-700">Link Kegiatan:</label>
					<input type="url" required id="url" required oninput="inputValidation(this)" name="link_kegiatan" class="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="https://example.com">
				...
				<div class="flex flex-col">
					...
					<div class="relative file-upload-container">
						<div class="bg-white drop-zone relative cursor-pointer transition-all text-center p-8 border-2 border-blue-400 border-2 border-dashed rounded-lg w-full shadow-lg transtition">
							...
							<input id="sertifikat" required name="sertifikat" accept="application/pdf" type="file" class="file-input hidden" />
