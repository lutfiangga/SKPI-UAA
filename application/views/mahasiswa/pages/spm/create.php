		...
		<form method="post" action="<?= site_url(ucwords($role) . '/Spm_Mahasiswa/save/') ?>" enctype="multipart/form-data" role="form">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				...
				<div class="flex flex-col">
					...
					<input type="text" id="nama_kegiatan" name="nama_kegiatan" class="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan Nama Kegiatan">
				</div>

				<!-- Penyelenggara -->
				<div class="flex flex-col">
					<label for="penyelenggara" class="mb-2 text-sm font-medium text-gray-700">Penyelenggara</label>
					<input type="text" id="penyelenggara" name="penyelenggara" class="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Masukkan Penyelenggara">
				</div>

				<!-- Tanggal -->
				<div class="flex flex-col relative">
					<label for="tanggal" class="mb-2 text-sm font-medium text-gray-700">Tanggal Mulai</label>
					<input type="text" name="tanggal_mulai" class="pickdate p-2 w-full rounded-md bg-[#fafafa] focus:ring-inset focus:ring-blue-400 border border-gray-300" placeholder="Tanggal mulai">
				</div>

				<div class="flex flex-col relative">
					<label for="tanggal" class="mb-2 text-sm font-medium text-gray-700">Tanggal Selesai</label>
					<input type="text" name="tanggal_selesai" class="pickdate p-2 w-full rounded-md bg-[#fafafa] focus:ring-inset focus:ring-blue-400 border border-gray-300" placeholder="tanggal Selesai">
				</div>

				<!-- Link Kegiatan -->
				<div class="flex flex-col">
					<label for="url" class="mb-2 text-sm font-medium text-gray-700">Link Kegiatan</label>
					<input type="url" id="url" oninput="inputValidation(this)" name="link_kegiatan" class="p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="https://example.com">
