<section class="relative flex flex-col justify-between">
	...
	<section class="relative bg-[#fafafa] rounded-2xl lg:p-8 p-4 my-4">
		<form method="post" action="<?= site_url(ucwords($role) . '/Kategori_Cpl/update/' . $edit['id_kategori_cpl']) ?>"
			enctype="multipart/form-data" role="form">
			<?= csrf(); ?>
			<div class="">
				<label for="kategori" class="block text-sm font-medium text-gray-700 mb-2">Bidang CPL:</label>
				<textarea type="text" id="kategori" name="kategori" required rows="2"
					...
					placeholder="Tata Nilai"><?= $edit['kategori']; ?></textarea>
			</div>

			<div class="divider border-gray-400"></div>
			<div class="relative">
				<a href="<?= site_url(ucwords($role) . '/Kategori_Cpl'); ?>"
